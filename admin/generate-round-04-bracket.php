...
if( isset( $_POST['form'] ) && isset( $_POST['tournament_id'] ) ) {
    ...
    if( $form == 'generate-matches' ) {
        ...
        $teams = $ez_tournament->get_round_winners( $tournament_id, 3 );
    ...
    ?>
        ...
        <?php $ez_tournament->set_tournament_matchups($tournament_id, $teams[0]['guild'], $teams[0]['guild_id'], $teams[1]['guild'], $teams[1]['guild_id'], '4'); ?>
        <li class="spacer">&nbsp;</li>
        ...
        <?php $ez_tournament->set_tournament_matchups($tournament_id, $teams[2]['guild'], $teams[2]['guild_id'], $teams[3]['guild'], $teams[3]['guild_id'], '4'); ?>
        <li class="spacer">&nbsp;</li>
