...
<?php if( $round2 ) { ?>
		...
		<li class="game game-spacer"><a href="view-tournaments.php?p=matchup&id=<?php echo $round2[4]['id'];  ?>">View Details</a></li>
		...
		<li class="game game-spacer"><a href="view-tournaments.php?p=matchup&id=<?php echo $round2[5]['id'];  ?>">View Details</a></li>
		...
		<li class="game game-spacer"><a href="view-tournaments.php?p=matchup&id=<?php echo $round2[6]['id'];  ?>">View Details</a></li>
		...
		<li class="game game-spacer"><a href="view-tournaments.php?p=matchup&id=<?php echo $round2[7]['id'];  ?>">View Details</a></li>
