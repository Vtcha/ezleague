...
<?php 
	...
	if( $match_details['home_accept'] == 1 && $match_details['away_accept'] == 1) {
		include('tpls/settings/leagues/view-match-admin-score.php');
		include('tpls/settings/leagues/view-match-admin-screenshot.php');
	}
	...
	if( $match_details['status'] == '0' ) {
			...
			include('tpls/settings/leagues/view-match-admin-details.php');
