<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-picture"></i><?php echo $match_details['league']; ?> Match Details 
		</div>
		<div class="tools">
		...
		if( $match_details['home_id'] == $profile['guild_id'] || $match_details['away_id'] == $profile['guild_id'] ) { 
			$team_admin = $ez_users->get_team_admin( $profile['guild_id'] );
			 if( $team_admin == $profile['username'] ) {
			 	include('tpls/settings/leagues/view-match-admin.php');
			 } else {
			 	include('tpls/settings/leagues/view-match-user.php');	
			 }
