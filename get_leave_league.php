	   ...
	   <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title">Leave League - <?php print $league['league']; ?></h4>
	      </div>
	      <div class="modal-body">
	       <p>Are you sure you want to leave this league? This action cannot be undone.</p>
	        <div class="row">
	         <div class="col-lg-12">
	       		<div id="leaveLeague">
	       		  <div class="col-lg-6">
	       			<form id="confirmLeaveLeague" name="confirmLeaveLeague" method="POST">
